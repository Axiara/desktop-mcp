...
class TestListWindowsTool:
    @patch("desktop_mcp.server.list_windows")
    def test_returns_json(self, mock_tool):
        """Test that the tool function would return JSON (testing server logic)."""
        # This tests the _compact_tree and serialization logic
        # Full integration with UIA is in test_integration.py
        pass
...
class TestTypeTextTool:
    ...
    def test_type_returns_info(self, mock_pag, monkeypatch):
        ...
        result = json.loads(type_text("hello world"))
